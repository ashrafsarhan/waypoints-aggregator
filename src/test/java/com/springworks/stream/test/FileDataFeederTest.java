...
public class FileDataFeederTest {
	...
	@Test
	public void test() {
		dataFeed.streamDataEvent().forEach(System.out::println);
		...
		assertEquals("Test Fails (Not the expected first event)", "2016-06-21T12:00:00.000Z", dataFeed.streamDataEvent().findFirst().get().getTimestamp());	
	}
